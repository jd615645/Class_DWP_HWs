$(document).ready(function() {
  $(document).on('click', '.btn_post', function() {
    ...
    $.post('outline_post.php', {title: title, local: local, goal: goal , time: time, outline: outline, standard: standard, book: book, conditional: conditional, data: data}, function(result) {
      console.log(result);
